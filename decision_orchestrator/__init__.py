"""Decision Orchestration Policy — combines adapter risk evidence into
transparent final decisions.

Consumes TLS Risk Policy Adapter output to produce
a transparent final decision (ALLOW / REVIEW / DENY).
