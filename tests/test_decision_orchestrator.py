...
- All 7 decision rules evaluate correctly
    - Auxiliary signal isolation (observational, never affects decisions)
...
class TestOrchestratorSchema(unittest.TestCase):
    ...
    def test_orchestrator_output_has_required_fields(self) -> None:
        out = decide(
            ...
            auxiliary_decision=False,
            auxiliary_confidence=0.9,
            classification="VALID_TLS",
        )
        required = [
            "classification", "final_decision", "final_risk",
            "primary_reason", "supporting_reasons", "decision_source",
            "auxiliary_decision", "auxiliary_confidence", "adapter_risk_category",
            "adapter_severity", "adapter_action_hint", "auxiliary_observed",
    ...
    def test_orchestrator_output_types(self) -> None:
        ...
        self.assertIsInstance(out["auxiliary_confidence"], (int, float))
        self.assertIsInstance(out["auxiliary_observed"], bool)
...
class TestDecisionRules(unittest.TestCase):
    ...
    def test_rule1_critical_overrides_fallback(self) -> None:
        out = decide(
            adapter_risk_category="SECURITY_RISK",
            adapter_severity="CRITICAL",
            adapter_action_hint="DENY",
    ...
    def test_rule3_security_review_with_auxiliary(self) -> None:
        out = decide(
            adapter_risk_category="SECURITY_RISK",
            adapter_severity="HIGH",
            adapter_action_hint="RENEW_OR_DENY",
    ...
    def test_rule5_balanced_fallback_allow(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_rule5_conservative_does_not_fallback_allow(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_rule5_balanced_fallback_with_clean_adapter(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_rule6_conservative_reviews_valid_tls(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_rule6_probe_limited_prevents_fallback_allow(self) -> None:
        """Even with balanced profile, probe-limited VALID_TLS cannot fallback to ALLOW."""
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
...
class TestConfidenceFallback(unittest.TestCase):
    """Fallback ALLOW rules for the balanced profile."""
    ...
    def test_fallback_used_when_clean_valid_tls_balanced(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_auxiliary_signals_no_influence_on_fallback(self) -> None:
        with_signals = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
            ...
            auxiliary_confidence=0.0,
            profile="balanced",
            auxiliary_signals={"connection_rtt": 0.05},
        )
        without_signals = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
            classification="VALID_TLS",
        ...
        self.assertEqual(with_signals["final_decision"], without_signals["final_decision"])
        self.assertTrue(with_signals["fallback_used"])
        self.assertTrue(without_signals["fallback_used"])

    def test_confidence_source_fallback(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
...
class TestRulePriority(unittest.TestCase):
    ...
    def test_availability_blocks_valid_tls(self) -> None:
        out = decide(
            adapter_risk_category="AVAILABILITY_RISK",
            adapter_severity="MEDIUM",
            adapter_action_hint="REVIEW",
...
class TestAuxiliarySignalIsolation(unittest.TestCase):
    """Auxiliary signals are observational only, never affects final decision."""

    def test_auxiliary_with_signals_still_allows(self) -> None:
        no_signals = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
        ...
        with_signals = decide(
            ...
            auxiliary_decision=False,
            auxiliary_confidence=0.9,
            auxiliary_signals={"connection_rtt": 0.05, "cert_age_days": 30},
        )
        self.assertEqual(no_signals["final_decision"], with_signals["final_decision"])

    def test_auxiliary_observed_flag_set(self) -> None:
        out_no = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
        ...
        self.assertFalse(out_no["auxiliary_observed"])
        self.assertTrue(out_yes["auxiliary_observed"])

    def test_auxiliary_empty_dict_not_observed(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
        ...
        self.assertFalse(out["auxiliary_observed"])

    def test_auxiliary_signals_dont_change_deny(self) -> None:
        out = decide(
            adapter_risk_category="SECURITY_RISK",
            adapter_severity="CRITICAL",
            adapter_action_hint="DENY",
...
class TestOrchestrateWrapper(unittest.TestCase):
    ...
    def test_orchestrate_with_partial_input(self) -> None:
        ...
        out = orchestrate(inp)
        self.assertEqual(out["final_decision"], "REVIEW")
        self.assertIsNone(out["auxiliary_decision"])
        self.assertEqual(out["auxiliary_confidence"], 0.0)
...
class TestSaveResults(unittest.TestCase):
    ...
    def test_save_results_creates_file(self) -> None:
        ...
        try:
            ...
            self.assertFalse(data["_metadata"]["auxiliary_available"])
        finally:
...
class TestIntegrationWithAdapter(unittest.TestCase):
    ...
    def test_adapter_valid_tls_allows(self) -> None:
        from tls_policy_adapter import classify_risk
...
class TestAdapterGuardrail(unittest.TestCase):
    ...
    def test_expired_cert_cannot_become_allow(self) -> None:
        out = decide(
            adapter_risk_category="SECURITY_RISK",
            adapter_severity="HIGH",
            adapter_action_hint="RENEW_OR_DENY",
    ...
    def test_expired_cert_denied_with_auxiliary_params(self) -> None:
        out = decide(
            adapter_risk_category="SECURITY_RISK",
            adapter_severity="HIGH",
            adapter_action_hint="RENEW_OR_DENY",
    ...
    def test_valid_tls_conservative_does_not_allow(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_valid_tls_balanced_allows(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
...
class TestOperatingProfiles(unittest.TestCase):
    ...
    def test_conservative_reviews_valid_tls(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_balanced_allows_valid_tls_via_fallback(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_strict_reviews_valid_tls(self) -> None:
        out = decide(
            adapter_risk_category="ACCEPTABLE_TLS",
            adapter_severity="NONE",
            adapter_action_hint="NONE",
    ...
    def test_auxiliary_metadata_never_affects_decisions_across_profiles(self) -> None:
        no_signals: OrchestratorOutput = decide(**self.VALID_TLS_ARGS, profile="conservative")
        with_signals: OrchestratorOutput = decide(
            **self.VALID_TLS_ARGS, profile="conservative",
            auxiliary_signals={"anomaly_score": 0.8},
        )
        self.assertEqual(no_signals["final_decision"], with_signals["final_decision"])

        no_signals_b = decide(**self.VALID_TLS_ARGS, profile="balanced")
        with_signals_b = decide(
            **self.VALID_TLS_ARGS, profile="balanced",
            auxiliary_signals={"anomaly_score": 0.8},
        )
        self.assertEqual(no_signals_b["final_decision"], with_signals_b["final_decision"])

        no_signals_s = decide(**self.VALID_TLS_ARGS, profile="strict")
        with_signals_s = decide(
            **self.VALID_TLS_ARGS, profile="strict",
            auxiliary_signals={"anomaly_score": 0.8},
        )
        self.assertEqual(no_signals_s["final_decision"], with_signals_s["final_decision"])
